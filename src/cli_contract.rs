...
pub static COMMAND_CONTRACTS: &[CommandContract] = &[
    ...
    CommandContract {
        name: "query",
        description: "Semantic symbol query by kind/name/effects/contracts/generics",
        stable_flags: &[
            "--project",
            "--kind",
            "--name",
    ...
    CommandContract {
        name: "symbols",
        description: "Workspace symbol index export for agent retrieval",
        stable_flags: &["--project", "--format", "--json"],
        output_modes: &["text", "json"],
    },
    CommandContract {
        name: "scaffold",
        description: "Generate typed boilerplate for structs/enums/functions/matches/tests",
        stable_flags: &[
            "subcommands:struct,enum,fn,match,test",
            "struct --field",
    ...
    CommandContract {
        name: "synthesize",
        description: "Synthesize function/test artifacts from restricted spec-first declarations",
        stable_flags: &["--from", "--project", "--json"],
        output_modes: &["text", "json"],
    },
    CommandContract {
        name: "patch",
        description: "Apply or preview structured symbol-aware source edits from patch JSON",
        stable_flags: &["--preview", "--apply", "--project", "--json"],
        output_modes: &["text", "json"],
    },
    CommandContract {
        name: "coverage",
    ...
    CommandContract {
        name: "test",
        description: "Run AIC fixture/attribute/property test categories",
        stable_flags: &[
            "--mode",
            "--filter",
            "--seed",
