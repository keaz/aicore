...
check_pass=(
  ...
  "examples/e6/std_docs_walkthrough.aic"
  "examples/e2/explicit_imports.aic"
  ...
  "examples/io/fs_async_await_bridge.aic"
  "examples/io/fs_async_runtime_controls.aic"
  "examples/io/fs_async_tasks.aic"
  "examples/io/async_nested_futures.aic"
  ...
  "examples/io/http_server_async_api.aic"
  "examples/io/http_server_streaming_api.aic"
  "examples/io/http_router.aic"
  "examples/io/prod_t1_intrinsics_runtime_smoke.aic"
  "examples/io/tls_connect.aic"
  "examples/io/tls_async_submit_wait.aic"
  ...
  "examples/data/map_bool_values.aic"
  "examples/data/map_u64_values.aic"
  "examples/data/map_bytes_and_u64_keys_values.aic"
  ...
  "examples/data/string_comparison_eq_ne.aic"
  "examples/data/string_ops.aic"
  "examples/data/string_unicode_case_trim.aic"
  ...
  "examples/core/async_trait_methods.aic"
  "examples/core/trait_sort.aic"
  "examples/core/trait_methods.aic"
  "examples/core/for_in_loop.aic"
  ...
  "examples/core/borrow_move_join_reinit.aic"
  "examples/core/borrow_call_move_reinit.aic"
  "examples/core/closure_fn_values.aic"
  "examples/core/leak_check_closure_capture.aic"
  "examples/core/tuple_types.aic"
  "examples/core/iterator_trait_pipeline.aic"
  "examples/core/dyn_trait_objects.aic"
  ...
  "examples/selfhost/driver_basic.aic"
  "examples/selfhost/driver_package"
...
run_pass=(
  ...
  "examples/core/borrow_move_join_reinit.aic"
  "examples/core/borrow_call_move_reinit.aic"
  "examples/core/closure_context_inference.aic"
  "examples/core/closure_fn_values.aic"
  "examples/core/leak_check_closure_capture.aic"
  "examples/core/tuple_types.aic"
  "examples/core/iterator_trait_pipeline.aic"
...
case "$MODE" in
  ...
  run)
    ...
    expect_run_value "examples/e1/syntax_showcase.aic" "42"
    expect_run_value "examples/e2/explicit_imports.aic" "42"
    expect_run_value "examples/e2/multi_file_app/src/main.aic" "42"
    expect_run_value "examples/io/fs_backup.aic" "42"
    expect_run_value "examples/io/fs_all_ops.aic" "42"
    expect_run_value "examples/io/fs_async_tasks.aic" "42"
    ...
    expect_run_value "examples/io/async_net_worker_pool.aic" "42"
    expect_run_value "examples/io/async_await_submit_bridge.aic" "42"
    expect_run_value "examples/io/async_nested_futures.aic" "42"
    ...
    expect_run_value "examples/io/tcp_socket_tuning.aic" "42"
    expect_run_value "examples/io/http_server_hello.aic" "42"
    expect_run_value "examples/io/http_server_async_api.aic" "42"
    expect_run_value "examples/io/http_server_streaming_api.aic" "42"
    ...
    expect_run_value "examples/io/tls_async_submit_wait.aic" "42"
    ...
    expect_run_value "examples/io/mutex_rwlock_shared_state.aic" "42"
    ...
    expect_run_value "examples/vscode/doc_hover_completion_showcase.aic" "42"
    expect_run_value "examples/vscode/debugger_launch_demo.aic" "42"
    ...
    expect_run_value "examples/core/async_trait_methods.aic" "42"
    expect_run_value "examples/core/trait_sort.aic" "42"
    expect_run_value "examples/core/trait_methods.aic" "42"
    expect_run_value "examples/core/for_in_loop.aic" "35"
    ...
    expect_run_value "examples/core/core_language_tour.aic" "42"
    expect_run_value "examples/core/traits_and_dispatch_tour.aic" "42"
    expect_run_value "examples/core/effects_capabilities_patterns_tour.aic" "42"
    expect_run_value "examples/core/opt_levels_demo.aic" "42"
    expect_run_value "examples/core/tail_call_optimization.aic" "42"
    expect_run_value "examples/core/sso_map_workload.aic" "42"
    expect_run_value "examples/core/loop_control.aic" "42"
    expect_run_value "examples/core/borrow_move_join_reinit.aic" "42"
    expect_run_value "examples/core/borrow_call_move_reinit.aic" "42"
    expect_run_value "examples/core/closure_fn_values.aic" "23"
    expect_run_value "examples/core/leak_check_closure_capture.aic" "42"
    expect_run_value "examples/core/iterator_trait_pipeline.aic" "42"
    ...
    expect_run_value "examples/core/closure_context_inference.aic" "42"
    expect_run_value "examples/core/pattern_guard_check.aic" "42"
    expect_run_value "examples/data/map_u64_values.aic" "42"
    expect_run_value "examples/data/map_bytes_and_u64_keys_values.aic" "42"
    if command -v clang >/dev/null 2>&1; then
      clang -O0 -c "examples/io/ffi_string_view_demo/native/ffi_string_view.c" -o "examples/io/ffi_string_view_demo/native/ffi_string_view.o"
      expect_run_value "examples/io/ffi_string_view_demo" "8"
    fi
    if command -v clang >/dev/null 2>&1; then
      clang -O0 -c "examples/io/ffi_string_view_return_demo/native/ffi_string_return.c" -o "examples/io/ffi_string_view_return_demo/native/ffi_string_return.o"
      expect_run_value "examples/io/ffi_string_view_return_demo" "8"
    fi
