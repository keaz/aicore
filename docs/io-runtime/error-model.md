...
- `E6007` is retained as a registered historical code for older tooling/docs compatibility, but current Windows-target builds no longer emit it after the shared Windows proc/net/concurrency runtime landed.
