...
| `E2006` | Concurrency resource protocol violation. | `fn read_cfg() -> Result[String, FsError] { std.fs.read_file("cfg.txt") }` | `fn read_cfg() -> Result[String, FsError] effects { fs } { std.fs.read_file("cfg.txt") }` |
