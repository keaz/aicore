...
#[test]
fn vscode_doc_hover_completion_example_is_listed_in_ci_and_runs() {
    let root = repo_root();
    let example_rel = "examples/vscode/doc_hover_completion_showcase.aic";
    let example_path = root.join(example_rel);
    assert!(
        example_path.is_file(),
        "doc hover/completion example missing: {}",
        example_path.display()
    );
...
#[test]
fn vscode_debugger_launch_example_is_listed_in_ci_and_runs() {
    let root = repo_root();
    let example_rel = "examples/vscode/debugger_launch_demo.aic";
    let example_path = root.join(example_rel);
    assert!(
        example_path.is_file(),
        "debugger launch example missing: {}",
        example_path.display()
    );
...
#[test]
fn vscode_folding_selection_example_is_listed_in_ci_and_runs() {
    let root = repo_root();
    let example_rel = "examples/vscode/folding_selection_showcase.aic";
    let example_path = root.join(example_rel);
    assert!(
        example_path.is_file(),
        "folding/selection example missing: {}",
        example_path.display()
    );
...
#[test]
fn vscode_auto_import_workspace_example_is_listed_in_ci_and_runs() {
    let root = repo_root();
    let example_rel = "examples/vscode/auto_import_workspace";
    let example_path = root.join(example_rel);
    assert!(
        example_path.is_dir(),
        "auto-import workspace example missing: {}",
        example_path.display()
    );
